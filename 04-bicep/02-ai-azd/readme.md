# Deploy the GenAIOps-project-template

template

The "GenAIOps-project-template " template is recommended for users looking to get started with Azure AI Studio.
...
[Azure AI App Templates](https://azure.github.io/ai-app-templates/)

Initialize the GenAIOps-project-template template:

```bash
azd init --template https://github.com/Azure/GenAIOps-project-template
```
...
> Note: The `GenAIOps-project-template  template` has been customized to deploy the `gpt-4o-mini` model by default. Also it does not deploy the `Machine Learning Workspace`.

## GenAIOps-project-template Template
